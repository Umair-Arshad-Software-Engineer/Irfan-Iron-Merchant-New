              ...
              child: Column(
                children: [
                  if (_filteredTransactions.isNotEmpty)
                    ...
                    //             .where((t) => t['type'].toString().contains('Sale'))
                    //             .fold(0.0, (sum, t) => sum + (t['total'] ?? 0.0)),
                    //         _filteredTransactions
                    //             .where((t) => t['type'].toString().contains('Sale'))
                    ...
                    //         _filteredTransactions
                    //             .where((t) => t['type'] == 'Purchase')
                    //             .fold(0.0, (sum, t) => sum + (t['quantity'] ?? 0.0)), // use quantity as weight
                  ...
                  // Padding(
                    ...
                    //         _filteredTransactions.where((t) => t['type'].toString().contains('Sale')).fold(0.0, (sum, t) => sum + (t['weight'] ?? 0.0)),
                    //         Colors.green,
                    //       ),
                    //       SizedBox(width: 8),
                    //       _buildSummaryCard(
                    ...
                    //         _filteredTransactions.where((t) => t['type'] == 'Purchase').fold(0.0, (sum, t) => sum + (t['weight'] ?? 0.0)),
                    //         Colors.blue,
                    //       ),
                    //     ],
                    //   ),
